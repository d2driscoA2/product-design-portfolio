...
function FloatingRings({ className }: { className?: string }) {
  ...
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      {rings.map((r) => (
        <circle key={r} cx="200" cy="200" r={r} stroke="#3B5CE8" strokeWidth="1" />
      ))}
    </svg>
  );
}
    ...
    <main className="about-main min-h-screen transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          <div className="md:col-span-1">
            ...
            <div className="mt-6 space-y-2">
              ...
              <a href="mailto:d2drisco@icloud.com" className="inline-flex items-center gap-1 text-sm font-medium text-[#3B5CE8] hover:opacity-70 transition-opacity" style={{textDecoration:'underline',textUnderlineOffset:'3px',textDecorationThickness:'1px'}}>d2drisco@icloud.com<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style={{display:'inline',marginLeft:'4px',verticalAlign:'middle'}}><path d="M2.5 9.5L9.5 2.5M9.5 2.5H4M9.5 2.5V8" stroke="#3B5CE8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></a>
            </div>
          </div>
        ...
        <div className="about-border border-t pt-16 grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
          {stats.map((stat) => (
            <div key={stat.label}>
              <p className="text-3xl font-bold mb-1 text-[#3B5CE8]">{stat.value}</p>
