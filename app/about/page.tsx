      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          ...
          <div className="md:col-span-2 space-y-6 text-lg leading-relaxed">
            ...
            <p className="about-body">I came to design through Human-Computer Interaction at Western Michigan University, after a student in the Waldo Library computer lab had a seizure in front of me. The trigger was a flashing pop-up ad. Design stopped being decoration for me that day. From there: four years at Appily.com (formerly Cappex) designing the college application platform that reached 47% completion against a 20–35% industry standard, then five years at TeleSign as Principal Product Designer protecting 21 billion annual transactions and rebuilding enterprise onboarding: same-day access for simpler products, and 67 days down to 35 for complex configurations requiring government approval.</p>
